...
Go to your GitHub Pages Repository you want to clone.

Click on Code on the main page of the repository.
To clone the repository under “Clone with HTTPS” click on the follwing icon